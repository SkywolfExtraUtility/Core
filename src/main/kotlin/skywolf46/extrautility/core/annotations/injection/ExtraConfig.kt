...
/**
 * Declare class as SkywolfExtraUtility configuration class.
 *  Module class is loading stage for [ExtraModule] and [ExtraService].
 *
 * Configuration class are highly not recommended for self-instantiation,
 ...
 *
 * Configuration class must have public constructor to inject, but cannot inject [ExtraModule] and [ExtraService] on constructor injection.
